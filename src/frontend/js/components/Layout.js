...
class Layout extends React.Component {
    ...
    componentDidUpdate = () => {
        if(this.props.rooms.fetched && this.props.videoPlayerReducer.inputURL === null) {
            ...
            socket.disconnect();
        } else if (this.props.videoPlayerReducer.requested) {
            console.log("this is what video is ", this.video);
            // this.video.playingTime();
            console.log("got here atleast ", this.props.videoPlayerReducer);
            // this.props.requested(this.props.videoPlayerReducer.requested);
        }
    }
